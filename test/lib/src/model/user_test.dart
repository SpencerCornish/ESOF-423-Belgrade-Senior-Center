...
void main() {
  ...
  final mockUserCsv = '"data_UID","Bachler","Dan","test@example.com","443 E Main Street Bozeman, MT 59715","phoneNumber","phoneNumber","position","admin","dietaryRestrictions","disabilities","medicalIssues","2/27/2019","2/27/2019"\n';
  group('User -', () {
